  ...
  constructor(options) {
    ...
    self.dispose = () => {
      ...
      if (self.options.scrollWheel == true) {
        self.container[0].removeEventListener("mousewheel", self.onMouseWheel, false);
        self.container[0].removeEventListener("DOMMouseScroll", self.onMouseWheel, false);
      }
    ...
    self.onMouseWheel = (e) => {
      let delta = 0;
      if (e.wheelDelta != null) delta = e.wheelDelta;
    ...
    if (self.options.scrollWheel == true) {
      self.container[0].addEventListener("mousewheel", self.onMouseWheel, false);
      self.container[0].addEventListener("DOMMouseScroll", self.onMouseWheel, false);
    }
