...
(function e(t, i) {
  ...
  var V = function (e, n) {
    ...
    c.switchFullscreen = function () {
      ...
      if (c.isFullscreen != true) {
        ...
        i("body").addClass("df-fullscreen-active");
        ...
        i("body").removeClass("df-fullscreen-active");
    ...
    n.prototype = {
      ...
      zoom: function (e) {
        ...
        var session = {
          ...
          rtl: this.options.direction === 2,
          page: this.target._activePage,
          zoom: this.zoomValue,
        };
        // saveSession(session);
      },
  ...
  var Q = (function (e) {
          ...
          a.contentProvider = new Y(
            ...
            function (n) {
              ...
              o.updatePageCallback = function () {
                var currentPage = o._activePage;
                a.ui.update();
                a.checkCenter();
                a.stage.renderRequestPending = true;

                // Save page for persistence
                window.saveLastPage(a.options.pdfId, currentPage);
                // Update debug info
    ...
    a.prototype.getURLHash = function () {
      var isRemotePDF =
        "string" == typeof this.options.source && this.options.source.startsWith("http");
      if (isRemotePDF) {
