...
export function toggleQuotePanel() {
  ...
  if ($("#quoteNotesPanel").hasClass("hidden")) {
    $("#toggleQuotePanelBtn").html('<i class="fas fa-comments"></i>').attr("title", "Toggle Quotes Panel");
  } else {
    $("#toggleQuotePanelBtn").html('<i class="fas fa-comments"></i>').attr("title", "Hide Quotes Panel");
  }
}
