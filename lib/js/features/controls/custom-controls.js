$(document).ready(function () {
    ...
    $(document).on("mousemove", function (e) {
        ...
        const mouseY = e.clientY; // Fixed from e.clientX to e.clientY
        const windowHeight = $(window).height();
        const threshold = 80; // Increased threshold for better reliability
    ...
    $(document).on("click", "#customPrevBtn", function (e) { 
        ...
        console.log("Prev clicked, fb found:", !!fb);
        if (fb) fb.prev(); 
    });
    $(document).on("click", "#customNextBtn", function (e) { 
        ...
        e.stopImmediatePropagation(); 
        const fb = getFlipbook(); 
        console.log("Next clicked, fb found:", !!fb);
        if (fb) fb.next(); 
    });
    ...
    function syncUI() {
        ...
        if (fb) {
            ...
            $("#customCurrentPage").text(current);
