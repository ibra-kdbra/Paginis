...
function extractYouTubeVideoId(url) {
    ...
    for (let i = 0; i < patterns.length; i++) {
        ...
        if (match && match[1]) {
            ...
            console.log('Found video ID:', videoId, 'using pattern', i);
            return videoId;
        }
    }
    ...
    try {
        ...
        if (videoId && videoId.length === 11) {
            console.log('Found video ID via search params:', videoId);
            return videoId;
        }
    } catch (e) {
...
function extractYouTubePlaylistId(url) {
    ...
    try {
        ...
        console.log('Found playlist ID:', listId);
        return listId;
    } catch (e) {
        console.log('Playlist ID extraction failed:', e);
        return null;
    }
}
...
$(document).ready(function () {
    ...
    $("#loadYoutubeBtn").click(function () {
        ...
        console.log('🎵 Loading YouTube URL:', youtubeUrl);
    ...
    $("#loadPlaylistBtn").click(function () {
        ...
        console.log('📋 Loading playlist from URL:', youtubeUrl);
        ...
        console.log('📺 Setting playlist embed URL:', embedUrl);
