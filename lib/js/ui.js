$(document).ready(function () {
    // Initialize default PDF URL in the input field
    // const defaultPdfUrl = 'https://7uzx5yn03h.ufs.sh/f/aLxFAGHMpUDrHJi2MUlQmdfILsR4SYX9vh5tGa0AxUy31OwF';
    // $("#pdfUrl").val(defaultPdfUrl);
    // console.log('Default PDF URL loaded:', defaultPdfUrl);
    ...
    // YouTube integration is now handled in the Media section as a source selector
